...
class ATAE_LSTM(nn.Module):
    ...
    def forward(self, inputs):
        text_indices, aspect_indices,supportset_size = inputs[0], inputs[1],inputs[2]
        text_indices = text_indices[supportset_size:]
        aspect_indices = aspect_indices[supportset_size:] ## get query set only
